  ...
  */
  constructor(object, options = { }) {
    ...
    if (window.isSecureContext === false) {
       ...
       * @event DeviceOrientationControls#devorienterror
       * @param {string} errorCode -the error code. 
       * @param {string} errorMessage - the full error message. 
       */
      this.eventEmitter.emit("devorienterror", 
    ...
    this.onPermissionsGranted = options.onPermissionsGranted || null;
  ...
  initPermissionDialog() {
    ...
    const onStartClick = () => {
      if(this.onPermissionsGranted) {
          // provide an event handler and call connect() from it
