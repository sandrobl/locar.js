...
/**
  ...
  */
  constructor(object, options = { }) {
    ...
    if (window.isSecureContext === false) {
      ...
      this.eventEmitter.emit("deviceorientationerror", 
        "LOCAR_DEVICE_ORIENTATION_NO_HTTPS",
    ...
    // see initPermissionDialog() below.
    // This is therefore tightly coupled to initPermissionDialog(), thus is 
    ...
    this.requestOrientationPermissions = function() {
      if (
        ...
        window.DeviceOrientationEvent.requestPermission()
          .then((response) => {
            if (response === "granted") {
               ...
               */
              this.eventEmitter.emit("deviceorientationerror", 
                "LOCAR_DEVICE_ORIENTATION_PERMISSION_DENIED",
          ...
          .catch(function (error) {
               ...
               */
              this.eventEmitter.emit("deviceorientationerror", 
                "LOCAR_DEVICE_ORIENTATION_PERMISSION_FAILED",
        ...
        this.eventEmitter.emit("deviceorientationerror",
            "LOCAR_DEVICE_ORIENTATION_INTERNAL_ERROR",
  ...
  if (isiOSWithReq && scope.enablePermissionDialog) {
    ...
    // "deviceorientationgranted" event stright away
    scope.eventEmitter.emit("deviceorientationgranted");
  }
