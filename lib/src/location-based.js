...
class LocationBased {
  ...
  _gpsReceived(position) {
    ...
    console.log(`_gpsReceived(): position ${position.coords.latitude},${position.coords.longitude}, accuracy ${position.coords.accuracy}, accuracy limit ${this._gpsMinAccuracy}`);
